...
//   // Пока идёт программный скролл к цели — не даём IntersectionObserver
//   // переопределять подсветку, которую мы только что выставили кликом.
//   let lockedId = null
...
//     // Снимаем блокировку не по событиям scroll (на iOS они ненадёжны),
//     // а опросом реального положения скролла.
//     const checkArrived = () => {
...
//         closeMobileMenu()
//         // ждём завершения анимации/разблокировки body, потом скроллим
//         requestAnimationFrame(() => {
//           requestAnimationFrame(() => {
//             scrollToId(targetId)
//           })
...
//         (entries) => {
//           if (lockedId) return // идёт клик-навигация — не мешаем
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // --- Клик по логотипу (header/footer): закрыть меню и наверх ---
